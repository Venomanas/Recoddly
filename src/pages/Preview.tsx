        ...
        <div className="container max-w-7xl mx-auto flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="sm" onClick={handleCopyLink}>
              {copied ? (
                <>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2"><path d="M20 6 9 17l-5-5"></path></svg>
                  Copied!
                </>
              ) : (
                <>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"></rect><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"></path></svg>
                  Copy Link
                </>
              )}
            </Button>
            ...
            <div className="rounded-[2rem] overflow-hidden w-[272px] h-[572px]">
              ...
              >
                ...
                <div className="flex flex-col items-center p-6">
                  ...
                  <h3 className={`font-bold text-lg text-white mb-1 ${profile.fontStyle}`}>
                    @{profile.username}
                  </h3>
                  <p className={`text-white/80 text-sm mb-6 ${profile.fontStyle}`}>
                    {profile.bio}
                  </p>
